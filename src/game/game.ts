...
import { MIN_TELEPORT_DEPTH_METERS, advanceTeleportEffect, canTeleportToSurface, canUseTeleporter, createTeleportEffect, teleportPlayerToReturn, teleportPlayerToSurface } from '../core/teleporter';
...
function applyAuthoritativeWorld(msg: Extract<import('../net/net-protocol').NetMessage, {type:'worldState'}>){
