...
import { findClosestEnemyTarget, findEnemyPathStep, type EnemyPosition } from './enemy-movement';
import { enemyBiteCooldown, enemyBiteDamage, enemyMoveDelay } from './enemy-types';
